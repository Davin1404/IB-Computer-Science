...
- **Object Reference**: A reference is a variable whose value indicates the memory location of an object.
...
> This section of the guide does not provide a direct summary of the mark scheme since it is not assessed in real IB exams.

- **Advantages**
  - **Code Reusability:** Inheritance allows new classes to be created using the properties and methods of existing classes, reducing redundancy.
  - **Hierarchical Organization:** It helps create a natural hierarchy for classes, making it easier to understand and manage complex software systems.
  - **Extensibility:** Enhances the ability to extend existing functionality without changing the existing code.
  - **Maintainability**: When a method is updated in the parent class, all inheriting classes automatically receive the updated behavior. This makes maintaining and updating software easier.
- **Disadvantages**
...
**Difference Between Pass by Value and Pass by Reference (ByRef)**
